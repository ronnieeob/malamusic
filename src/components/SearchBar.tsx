    ...
    <div className="relative search-container">
      <div className="flex items-center space-x-4 mb-4 relative">
        <select
          ...
          className="bg-zinc-800/50 border border-red-900/20 rounded px-3 py-2 text-sm z-10"
        >
        ...
        <div className="relative flex-1">
          <input
            ...
            className="w-full bg-zinc-800/50 border border-red-900/20 rounded-lg py-3 px-4 pl-12 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all"
          />
      ...
      {showResults && query.trim() && (
        <div className="absolute w-full mt-2 bg-zinc-900 rounded-lg border border-red-900/20 shadow-lg overflow-hidden z-50">
          {error && (
              ...
              <div className="space-y-2">
                {searchHistory.map((search, index) => (
                  <button
                    ...
                    className="block w-full text-left px-2 py-1 hover:bg-red-900/20 rounded"
                  >
                    {search}
                  </button>
                ))}
