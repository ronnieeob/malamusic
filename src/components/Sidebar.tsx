...
import { Home, Library, Search, PlusCircle, Music, LogOut, ShoppingBag } from 'lucide-react';
    ...
    <aside className="w-full md:w-64 bg-black/50 text-white p-4 md:p-6 flex flex-col md:h-screen border-b md:border-r border-blue-900/20">
      ...
      <div className="mt-auto pt-4 border-t border-blue-900/20">
        <button
          ...
          className="flex items-center space-x-2 w-full px-3 py-2 text-blue-400 hover:bg-blue-900/20 rounded-lg transition"
        >
