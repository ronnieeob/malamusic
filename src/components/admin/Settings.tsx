...
export function Settings() {
  ...
  const handleSave = async () => {
    try {
      ...
      localStorage.setItem('metal_aloud_website_image', branding.websiteImage);
      localStorage.setItem('metal_aloud_favicon', branding.favicon);
      ...
      // Update website logo in DOM
      const logos = document.querySelectorAll('img[alt="Metal Aloud"]');
      logos.forEach(logo => {
        if (logo instanceof HTMLImageElement && branding.websiteImage) {
          logo.src = branding.websiteImage;
        }
      });
