...
export function PremiumSettings() {
  ...
  const handleSave = async () => {
    try {
      ...
      localStorage.setItem('metal_aloud_premium_enabled', JSON.stringify(premiumEnabled));
      localStorage.setItem('metal_aloud_payment_keys', JSON.stringify(paymentKeys));
